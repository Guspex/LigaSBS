...
def tabela_html_cartas(cartas, altura_px=350):
    ...
    html += "</tr></thead></table>"
    html += f"""<div style="max-height:{altura_px}px;overflow-x:hidden;"><table style='border-collapse:collapse;width:100%;font-family:"Segoe UI",Roboto,Arial,sans-serif;font-size:12px;table-layout:fixed;'><tbody>"""
    for carta in cartas:
